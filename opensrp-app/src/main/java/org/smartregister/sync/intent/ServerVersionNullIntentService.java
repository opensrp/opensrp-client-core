...
// */
//public class ServerVersionNullIntentService extends BaseSyncIntentService {
//
...
//
//    public ServerVersionNullIntentService() {
//        super("ServerVersionNullIntentService");
//    }
//
//    @Override
...
//            List<JSONObject> events = db.getUnValidatedEvents(fetchLimit,true);
//            if(clients.size() == 0 && events.size() == 0){
//                broadcastStatus(STATUS_NOTHING);
//                return;
//            }
//            Utils.appendLog("SYNC_URL","ServerVersionNullIntentService>clients.size():"+clients.size()+":event size:"+events.size());
//
...
//                return;
//            }
//            Utils.appendLog("SYNC_URL","ServerVersionNullIntentService>jsonPayload:"+jsonPayload);
//
