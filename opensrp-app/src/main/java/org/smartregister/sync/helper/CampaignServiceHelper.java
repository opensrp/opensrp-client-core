...
public class CampaignServiceHelper {
    private static final String TAG = CampaignServiceHelper.class.getCanonicalName();
    ...
    public CampaignServiceHelper(String baseUrl, HTTPAgent httpAgent) {
    ...
    public Campaign testSerialize(String obj) {
        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ")
                .registerTypeAdapter(DateTime.class, new DateTimeTypeConverter()).create();
        return gson.fromJson(obj, Campaign.class);
    }
