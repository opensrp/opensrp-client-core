...
public class NativePNCSmartRegisterViewHolder {
    ...
    public NativePNCSmartRegisterViewHolder(ViewGroup itemView) {
        ...
        this.pncOverviewServiceModeView = (ViewGroup) itemView
                .findViewById(R.id.pnc_overview_service_mode_views);

        this.deliveryInfoView = (DeliveryInfoView) pncOverviewServiceModeView
                .findViewById(R.id.delivery_info_layout);
        this.deliveryInfoView.initialize();

        txtComplicationsView = (TextView) pncOverviewServiceModeView
                .findViewById(R.id.txt_complications);

        pncPpFpMethodView = (ClientPNCPpFpMethodView) pncOverviewServiceModeView
                .findViewById(R.id.pp_fp_method_layout);
        ...
        childHolderLayout = (LinearLayout) pncOverviewServiceModeView
                .findViewById(R.id.lyt_pnc_child_holder);

        editButton = (ImageButton) pncOverviewServiceModeView.findViewById(R.id.btn_edit);

        this.pncVisitsServiceModeView = (ViewGroup) itemView
                .findViewById(R.id.pnc_visits_service_mode_views);
        ...
        txtVisitComplicationsView = (TextView) pncVisitsServiceModeView
                .findViewById(R.id.txt_pnc_visits_complications);

        wbvPncVisitsGraph = (WebView) pncVisitsServiceModeView
                .findViewById(R.id.wbv_pnc_visit_graph);
        ...
        recentPNCVisitsLayout = (LinearLayout) pncVisitsServiceModeView
                .findViewById(R.id.lyt_pnc_recent_visits_holder);
        ...
        txtPNCVisitDueType = (TextView) pncVisitsServiceModeView
                .findViewById(R.id.txt_pnc_visit_due_type);
        txtPNCVisitAlertDueOn = (TextView) pncVisitsServiceModeView
