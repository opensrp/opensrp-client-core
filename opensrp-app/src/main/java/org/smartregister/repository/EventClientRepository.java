...
public class EventClientRepository extends BaseRepository {
    ...
    private static final String TAG = "EventClientRepository";
    ...
    public int getUnSyncClientsCount(){
        List<JSONObject> list = getUnSyncedClientForceSync(0);
        if(list !=null){
            return list.size();
        }
        return 0;
    ...
    public int getUnSyncEventsCount(){
        List<JSONObject> list = getUnSyncedEventsForceSync(0);
        if(list !=null){
            return list.size();
        }
        return 0;
