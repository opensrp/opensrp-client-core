...
public class FormSubmissionConvertor {
    public static List<org.smartregister.domain.form.FormSubmission> toDomain(List<FormSubmissionDTO> formSubmissionsDto) {
        List<org.smartregister.domain.form.FormSubmission> submissions = new ArrayList<org.smartregister.domain.form.FormSubmission>();
