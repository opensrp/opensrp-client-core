...
public class ClientProcessor {
    ...
    protected String getHumanReadableConceptResponse(String value, JSONObject jsonDocObject) throws Exception {
        ...
        if (jsonDocObject == null || humanReadableValues == null || humanReadableValues.length() == 0) {
            String humanReadableValue = org.opensrp.Context.getInstance().customHumanReadableConceptResponse().get(value);
    ...
    public Long executeInsertStatement(ContentValues values, String tableName) {
        CommonRepository cr = org.opensrp.Context.getInstance().commonrepository(tableName);
    ...
    public void executeInsertAlert(ContentValues contentValues) {
        if (!contentValues.getAsString(AlertRepository.ALERTS_STATUS_COLUMN).isEmpty()) {
            ...
            AlertService alertService = org.opensrp.Context.getInstance().alertService();
    ...
    public void updateFTSsearch(String tableName, String entityId, ContentValues contentValues) {
        ...
        AllCommonsRepository allCommonsRepository = org.opensrp.Context.getInstance().allCommonsRepositoryobjects(tableName);
