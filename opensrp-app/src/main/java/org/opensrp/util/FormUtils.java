...
import org.opensrp.clientandeventmodel.FormAttributeParser;
import org.opensrp.clientandeventmodel.FormData;
import org.opensrp.clientandeventmodel.FormEntityConverter;
import org.opensrp.clientandeventmodel.FormField;
import org.opensrp.clientandeventmodel.FormInstance;
import org.opensrp.clientandeventmodel.SubFormData;
import org.opensrp.service.intentservices.ReplicationIntentService;
import org.opensrp.domain.SyncStatus;
import org.opensrp.domain.form.FormSubmission;
import org.opensrp.domain.form.SubForm;
...
public class FormUtils {
    ...
    private org.opensrp.Context theAppContext;
    ...
    public FormUtils(Context context) throws Exception {
        mContext = context;
        theAppContext = org.opensrp.Context.getInstance();
    ...
    private void generateClientAndEventModelsForFormSubmission(FormSubmission formSubmission, String formName) {
        org.opensrp.clientandeventmodel.FormSubmission v2FormSubmission;

        String anmId = org.opensrp.Context.getInstance().anmService().fetchDetails().name();
        ...
        v2FormSubmission = new org.opensrp.clientandeventmodel.FormSubmission(anmId, instanceId, formName, entityId, clientVersion, formDataDefinitionVersion, formInstance, clientVersion);
        ...
        printEvent(e);
        org.opensrp.cloudant.models.Event event = new org.opensrp.cloudant.models.Event(e);
        createNewEventDocument(event);
        if (c != null) {
            org.opensrp.cloudant.models.Client client = new org.opensrp.cloudant.models.Client(c);
        ...
        for (Map<String, Object> cm : dep.values()) {
            ...
            event = new org.opensrp.cloudant.models.Event(evin);
            createNewEventDocument(event);

            if (cin != null) {
                org.opensrp.cloudant.models.Client client = new org.opensrp.cloudant.models.Client(cin);
                createNewClientDocument(client);
                printClient(cin);
            }
            printEvent(evin);
    ...
    private List<FormField> convertFormFields(List<org.opensrp.domain.form.FormField> formFields) {
        List<FormField> fields = new ArrayList<FormField>();
        for (org.opensrp.domain.form.FormField ff : formFields) {
    ...
    private void createNewEventDocument(org.opensrp.cloudant.models.Event event) {
        mCloudantDataHandler.createEventDocument(event);

    }

    private void createNewClientDocument(org.opensrp.cloudant.models.Client client) {
