...
import static org.opensrp.AllConstants.FormNames.PNC_POSTPARTUM_FAMILY_PLANNING;
...
public class PNCOverviewServiceMode extends ServiceModeOption {
    ...
    private void setChildView(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder) {
        ...
        for (ChildClient child : client.children()) {
            ...
            ((TextView) childViewGroup.findViewById(R.id.txt_child_weight)).setText(String.format(org.opensrp.Context.getInstance().getStringResource(R.string.str_pnc_child_weight), child.weight()));
